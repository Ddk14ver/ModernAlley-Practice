    ...
    public List<String> getLines(Profile profile) {
        ...
        for (String line : template) {
            ...
            String processedLine = CC.translate(line)
                    ...
                    .replace("{kills}", String.valueOf(profile.getProfileData().getTotalFFAKills()))
                    .replace("{coins}", String.valueOf(profile.getProfileData().getCoins()))
            ...
            if (profile.getParty() != null && profile.getParty().getLeader() != null) {
                ...
                processedLine = CC.translate(processedLine)
                        ...
                        .replace("{party-leader}", leaderProfile == null
                                ? profile.getParty().getLeader().getName()
                                : leaderProfile.getFancyName());
            }
