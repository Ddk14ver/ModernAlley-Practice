...
public class TournamentScoreboardImpl implements Scoreboard {
     ...
     *
     * 根据状态计算阶段显示中剩余的队伍数量：
     * - IN_PROGRESS/INTERMISSION：使用 roundParticipants 的大小
     * - STARTING/WAITING：通过 total waiting players / team size 向下取整估算，
     *   受 maxTeams 限制，且至少为 0
     *
     ...
     *
     * 返回计分板的开始倒计时，经调整以匹配聊天显示。
     * 任务在递减之前打印；计分板在之后读取，因此需要加 1。
     *
