...
public class ShopMenu extends Menu {
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        buttons.put(13, new ShopCategoryButton(CosmeticType.SUIT, Material.GOLDEN_CHESTPLATE));
        buttons.put(14, new ShopCategoryButton(CosmeticType.PROJECTILE_TRAIL, Material.ARROW));
        buttons.put(15, new ShopCategoryButton(CosmeticType.KILL_MESSAGE, Material.WRITABLE_BOOK));
        buttons.put(16, new ShopCategoryButton(CosmeticType.TITLE, Material.NAME_TAG));
        buttons.put(19, new ShopCategoryButton(CosmeticType.MVP_MUSIC, Material.JUKEBOX));
