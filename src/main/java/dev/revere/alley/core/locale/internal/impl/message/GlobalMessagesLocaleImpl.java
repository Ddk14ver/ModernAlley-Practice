...
public enum GlobalMessagesLocaleImpl implements LocaleEntry {
    ...
    ERROR_YOU_CANNOT_SPECTATE_IN_TOURNAMENT("messages/global-messages.yml", "error-messages.you.cannot-spectate-in-tournament", "&cYou cannot spectate whilst in a tournament."),
    ...
    FFA_DELETED("messages/global-messages.yml", "ffa.command.deleted", "&aSuccessfully deleted the FFA configuration for kit &6{kit-name}&a!"),
