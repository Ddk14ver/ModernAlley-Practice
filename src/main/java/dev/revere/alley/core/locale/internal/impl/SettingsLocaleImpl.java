...
public enum SettingsLocaleImpl implements LocaleEntry {
    ...
    MVP_MUSIC_PACK_HOST("settings.yml", "mvp-music.pack-host", "127.0.0.1"),
    MVP_MUSIC_PACK_PORT("settings.yml", "mvp-music.pack-port", 8123),
    MVP_MUSIC_PACK_URL_OVERRIDE("settings.yml", "mvp-music.pack-url-override", "");
