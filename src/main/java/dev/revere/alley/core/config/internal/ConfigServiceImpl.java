 ...
 *
 * 配置服务的实现类，负责加载、重载和保存所有 YAML 配置文件。
 * Implementation of the config service, responsible for loading, reloading and saving all YAML config files.
 */
@Getter
...
public class ConfigServiceImpl implements ConfigService {
    ...
    private final String[] configFileNames = {
            ...
            "providers/pearls.yml", "providers/abilities.yml", "providers/visuals.yml", "providers/bots.yml",
     ...
     *
     * 依赖注入构造函数，从 AlleyContext 接收主引导实例。
     */
