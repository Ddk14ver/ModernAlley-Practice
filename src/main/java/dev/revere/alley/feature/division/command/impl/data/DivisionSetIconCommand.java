...
public class DivisionSetIconCommand extends BaseCommand {
    ...
    public void onCommand(CommandArgs command) {
        ...
        division.setIcon(player.getInventory().getItemInMainHand().getType());
        division.setDurability(player.getInventory().getItemInMainHand().getDurability());
        ...
        player.sendMessage(this.getString(GlobalMessagesLocaleImpl.DIVISION_ICON_SET)
                ...
                .replace("{item-type}", player.getInventory().getItemInMainHand().getType().name())
                .replace("{item-durability}", String.valueOf(player.getInventory().getItemInMainHand().getDurability()))
        );
    }
}
