...
public class Cooldown {
    ...
    public Cooldown(CooldownType type, Runnable actionToRun) {
        this(type, type.getCooldownDuration(), actionToRun);
    }

    public Cooldown(CooldownType type, long durationMillis, Runnable actionToRun) {
        this.type = type;
    ...
    public long calculateEndTime() {
        return this.startTime + this.durationMillis;
    }
