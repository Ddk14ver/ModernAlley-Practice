...
public class AlleyCommand extends BaseCommand {
    ...
    @CommandData(
            name = "alley",
            aliases = {"apractice", "aprac", "practice", "prac", "hamza", "emmy", "remi", "revere", "ddk1"},
            inGameOnly = false,
            usage = "alley",
    ...
    public void onCommand(CommandArgs command) {
        ...
        Arrays.asList(
                ...
                "      &6&l│ &fModernized by: &6Ddk1|AI Coding.",
    ...
    private @NotNull TextComponent createLinkComponent() {
        ...
        TextComponent discordComponent = ClickableUtil.createLinkComponent("&9&l[DISCORD]", "https://discord.gg/bEsW59UBG", "&aClick to join the Revere Discord.");
        TextComponent builtByBitComponent = ClickableUtil.createLinkComponent("&b&l[BUILTBYBIT]", "https://builtbybit.com/resources/alley-next-generation-practice-core.7308/", "&aClick to open the BuiltByBit resource page.");
