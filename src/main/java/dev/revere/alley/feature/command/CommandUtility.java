...
import dev.revere.alley.core.profile.data.command.ranked.RankedCommand;
import dev.revere.alley.core.profile.data.command.ResetStatsCommand;
import dev.revere.alley.core.profile.data.command.coin.SetCoinsCommand;
