...
public class CosmeticsMenu extends Menu {
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        buttons.put(13, new CosmeticCategoryButton(CosmeticType.SUIT, Material.GOLDEN_CHESTPLATE));
        buttons.put(14, new CosmeticCategoryButton(CosmeticType.PROJECTILE_TRAIL, Material.ARROW));
        buttons.put(15, new CosmeticCategoryButton(CosmeticType.KILL_MESSAGE, Material.WRITABLE_BOOK));
        buttons.put(16, new CosmeticCategoryButton(CosmeticType.MVP_MUSIC, Material.JUKEBOX));
