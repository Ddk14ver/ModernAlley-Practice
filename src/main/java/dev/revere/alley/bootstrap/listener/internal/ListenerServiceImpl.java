...
import dev.revere.alley.feature.kit.setting.listener.KitSettingSwimmingListener;
...
public class ListenerServiceImpl implements ListenerService {
    ...
    public void registerListeners(AlleyPlugin plugin) {
        KitSettingSwimmingListener kitSettingSwimmingListener = new KitSettingSwimmingListener(plugin);
        kitSettingSwimmingListener.start();
